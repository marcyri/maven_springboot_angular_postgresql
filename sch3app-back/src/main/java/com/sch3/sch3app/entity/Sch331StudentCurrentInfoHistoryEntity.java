...
@Entity
@Table(name = "sch3_31_student_current_info_history", schema = "public", catalog = "nvl_sch3")
public class Sch331StudentCurrentInfoHistoryEntity {
    ...
    public boolean equals(Object o) {
        ...
        Sch331StudentCurrentInfoHistoryEntity that = (Sch331StudentCurrentInfoHistoryEntity) o;
    ...
    @ManyToOne
    @JoinColumn(name = "student_photo_id", referencedColumnName = "student_photo_id", nullable = false)
